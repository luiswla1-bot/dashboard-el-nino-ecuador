...
if seccion_actual == "📈 Índice RONI":
    ...
    # ---- Pronóstico oficial de probabilidades (próximas 9 temporadas) ----
    st.markdown("<hr style='margin:14px 0 8px 0;'>", unsafe_allow_html=True)
    st.markdown("<div style='font-size:0.95rem; font-weight:600;'>🔮 Pronóstico oficial NOAA/CPC — próximas 9 temporadas</div>", unsafe_allow_html=True)
    ...
    if df_prob is not None and len(df_prob) > 0:
        ...
        fig_prob.update_layout(
            barmode='stack', height=280, yaxis_title="Probabilidad (%)",
